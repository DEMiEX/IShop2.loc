...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 01 2019 г., 17:50
...
--
-- Структура таблицы `category` категория
--
--id
--название категории
--короткое название для обращения с ссылочной строки
--id категории в которой находиться текущая подкатегория
--ключевые слова
--описание
...
--
-- Структура таблицы `currency` валюта
--
--id
--название валюты
--код валюты
...
--
-- Структура таблицы `gallery` галерея товара
--
-- id
-- id продукта
-- картика
...
--
-- Структура таблицы `modification` модефикации товара
--
-- id
-- id продукта
-- название
...
--
-- Структура таблицы `order` Заказа
--
--id заказа
--id ползователя который оформил заказ
--статус выполнения заказа
--дата оформления заказа
--дата оброботки заказа
--валюта в которой был оформлен заказ
--примечения
...
--
-- Структура таблицы `order_product` заказаных товаров
--
-- id 
-- id заказа
...
--
--id товара
--id категории к которой он относится
--id бренда к которому относится
--название товара
--короткое название по которому осуществляется поиск
--цена товара
--старая цена товара
--статус отображения товара на сайте
--ключивые слова по товару
--описание товара
--картинка товара
--является товар хитом
...
--
-- Дамп данных таблицы `product` Товар
--
...
--
--id товара 
--id товара рекомендуемого для просмотра
...
--
--id генерируемое поле индефикации пользовотеля
--лоин пользовотеля
--пароль
--почтовый ящик
--имя по которому будет идти обращение к пользователю
--адресс по которому будет отправлен заказ
--роль пользователя по умелчанию user
